    ...
    setTimeout(() => {
      ...
      if (apiOptions.isPT) {
        axios.defaults.baseURL =
          apiOptions.version === 2
            ? (import.meta.env.VITE_APP_API_BASEPTURL2 as string)
            : (import.meta.env.VITE_APP_API_BASEPTURL3 as string)
        ...
        axios.defaults.baseURL =
          apiOptions.version === 2
            ? (import.meta.env.VITE_APP_API_BASEURL2 as string)
            : (import.meta.env.VITE_APP_API_BASEURL3 as string)
      }
